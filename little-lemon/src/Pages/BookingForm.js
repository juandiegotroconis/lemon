      ...
      <form id='booking-form'>
        ...
        />
        {
          <span
            style={{
              display:
                touched.date && touched.time && !validations.date ? "" : "none",
            }}
          >
            {booking.date
              ? "You can't make a reservation in the past, remember the time!"
        ...
        <select
          ...
          value={booking.time}
          style={{
            border: touched.time && !validations.date ? "solid red 1.5px" : "",
          }}
          required
        >
          <option />
